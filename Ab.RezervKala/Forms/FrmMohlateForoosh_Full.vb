...
Friend Class FrmMohlateForoosh_Full
...
#Region "Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.pnlGridMaster.Location = New System.Drawing.Point(1, 59)
        Me.pnlGridMaster.Name = "pnlGridMaster"
        Me.pnlGridMaster.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.pnlGridMaster.Size = New System.Drawing.Size(872, 99)
        ...
        Me.pnlNavigationMaster.Location = New System.Drawing.Point(2, 162)
        Me.pnlNavigationMaster.Name = "pnlNavigationMaster"
        Me.pnlNavigationMaster.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.pnlNavigationMaster.Size = New System.Drawing.Size(269, 33)
        ...
        Me.pnlCommandMaster.Location = New System.Drawing.Point(575, 162)
        Me.pnlCommandMaster.Name = "pnlCommandMaster"
        Me.pnlCommandMaster.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.pnlCommandMaster.Size = New System.Drawing.Size(298, 33)
        ...
        Me.pnlNavigationDet.Location = New System.Drawing.Point(4, 178)
        Me.pnlNavigationDet.Name = "pnlNavigationDet"
        Me.pnlNavigationDet.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.pnlNavigationDet.Size = New System.Drawing.Size(267, 33)
        ...
        Me.pnlCommandDet.Location = New System.Drawing.Point(575, 178)
        ...
        Me.pnlGridDet.Size = New System.Drawing.Size(872, 102)
        ...
        Me.Panel1.Size = New System.Drawing.Size(877, 199)
        ...
        Me.btnAdd.Location = New System.Drawing.Point(505, 165)
        ...
        Me.Panel3.Size = New System.Drawing.Size(877, 57)
        Me.Panel3.TabIndex = 41
        '
        'btnFilterAsnadAnbar
        '
        Me.btnFilterAsnadAnbar.FlatStyle = System.Windows.Forms.FlatStyle.System
        Me.btnFilterAsnadAnbar.Location = New System.Drawing.Point(96, 12)
        ...
        'btnSelect
        '
        Me.btnSelect.Location = New System.Drawing.Point(4, 12)
        ...
        Me.dcbKala.Location = New System.Drawing.Point(473, 12)
        ...
        Me.Label5.Location = New System.Drawing.Point(806, 14)
        ...
        Me.Panel2.Size = New System.Drawing.Size(877, 214)
        ...
        Me.Panel4.Size = New System.Drawing.Size(877, 69)
        ...
        Me.txtMohlatDate.Location = New System.Drawing.Point(319, 40)
        ...
        Me.dcbKala2.Location = New System.Drawing.Point(474, 10)
        Me.dcbKala2.MemFilter = ""
        Me.dcbKala2.Name = "dcbKala2"
        Me.dcbKala2.SeparatedData = Nothing
        Me.dcbKala2.Size = New System.Drawing.Size(327, 21)
        ...
        Me.Label2.Location = New System.Drawing.Point(807, 12)
        ...
        Me.txtSabtDate.Location = New System.Drawing.Point(319, 14)
        ...
        Me.dcbStatus.Location = New System.Drawing.Point(473, 41)
        Me.dcbStatus.MemFilter = ""
        Me.dcbStatus.Name = "dcbStatus"
        Me.dcbStatus.SeparatedData = Nothing
        Me.dcbStatus.Size = New System.Drawing.Size(327, 21)
        ...
        Me.lblFromDate.Location = New System.Drawing.Point(389, 18)
        ...
        Me.Label1.Location = New System.Drawing.Point(807, 42)
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmMohlateForoosh_Full
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmMohlateForoosh_Full

        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmMohlateForoosh_Full()
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get

        Set(value As FrmMohlateForoosh_Full)
...
#End Region
    ...
    Private WithEvents DVabKalaRahgiri As CDataView

    'يك ديتا ويو از نوع ابزار جهت نمايش  کالاهاي رزرو شده تعريف شده است
    Private WithEvents DVabMohlateForoosh As CDataView
    ...
    Dim _SabtDate, _MohlatdaTe As String
    ...
    'Private Sub DVabMohlateForoosh_AfterCommandClick(ByVal aCommand As EnumCommands) _
    '    Handles DVabMohlateForoosh.AfterCommandClick
    ...
    '                DVabMohlateForoosh.Fields("AnbarSN").Value = .TextMatrix(.Row, .ColIndex("AnbarSN"))
    '                DVabMohlateForoosh.Fields("NoeAnbarSN").Value = .TextMatrix(.Row, .ColIndex("NoeAnbarSN"))
    '            End With
    '    End Select
    'End Sub
    ...
    'Private Sub DVabMohlateForoosh_FillDetailsWithData(ByVal aClip As Object, ByVal aFetched As Boolean) _
    '    Handles DVabMohlateForoosh.FillDetailsWithData
    '    With DVabMohlateForoosh
    '        If aFetched Then
    '            If Val(DVabMohlateForoosh.Fields("AnbarKalaRezervStatus").Value) = 0 Or _
    '               DVabMohlateForoosh.Fields("PayeSN").Value <> "6" Then
    '                .CommandEnabled(EnumCommands.cmEdit) = False
    '                .CommandEnabled(EnumCommands.cmDelete) = False
    '            ElseIf DVabMohlateForoosh.Fields("PayeSN").Value = "6" Then
    ...
    '            End If
    '        End With
    '        DVabMohlateForoosh.SQLWhere = vSql_where
    '        DVabMohlateForoosh.Refresh()
    ...
    Private Sub InitDataView_KalaRahgiri()
        ...
        DVabKalaRahgiri = New CDataView(cn)

        With DVabKalaRahgiri
            ...
            .DataSource = ds.Tables("tblMojoodi").DefaultView
            .Text = Me.Text
    ...
    Private Sub InitDataView_Mohlat()
        ...
        With DVabMohlateForoosh
            ...
            With .Fields
                ...
                With .Add("ShomarehRahgiri", "TextBox <Enabled>", EnumFieldOptions.foDefault)
                ...
                With .Add("Mojoodi", "TextBox", EnumFieldOptions.foDefault)
                    .Caption = "موجودی"
                    .MaxLength = 10
                    '.ReadOnly = True
                End With

                With .Add("MeghdareForoosh", "TextBox <Enabled>", EnumFieldOptions.foDefault)
                    .Caption = "مقدار انتظار"
                    .MaxLength = 100
                    .AllowNulls = False
                End With

                With .Add("MohlateForooshStatusSN->abMohlateForooshStatus.MohlateForooshStatusDS", "DataCombo", EnumFieldOptions.foDefault)
                    .Caption = "وضعیت"
                    .DefaultValue = 1.935
                End With
                ...
                With .Add("ToolidDate", "TextBox <Enabled>", EnumFieldOptions.foDate)
                    .Caption = "تاریخ تولید"
                    .MaxLength = 100
                    '.AllowNulls = False
                    .ReadOnly = True
                ...
                With .Add("EnghezaDate", "TextBox <Enabled>", EnumFieldOptions.foDate)
    ...
    Private Sub SetColumnseting()

        With DVabKalaRahgiri
            Dim i As Int16
            Dim dvTableFooter As DataView = cn.ExecuteQuery( _
                         "SELECT ObjectHaDS,ObjectHaFDS FROM PaObject T1 INNER JOIN PaObjectHa T2 ON T1.ObjectSN = T2.ObjectSN WHERE T1.ObjectDS='abQuery_Mojoodi' AND ObjectHaNo <> '0' ORDER BY CAST(ObjectHaNo AS BIGINT)")

            For i = 0 To dvTableFooter.Count - 1
                With DVabKalaRahgiri.Fields
                    Try
                        With .Item(dvTableFooter.Item(i).Item("ObjectHaDS")) '', "TextBox", EnumFieldOptions.foDefault)
            ...
            With DVabKalaRahgiri.Fields
                .Item("Mojoodi").Format = "N0"
                .Item("Box_Mojoodi").Format = "N0"
                .Item("Can_Mojoodi").Format = "N0"
                .Item("SumVaredeh").Format = "N0"
                .Item("Box_in").Format = "N0"
                .Item("Can_in").Format = "N0"
                .Item("SumSadereh").Format = "N0"
                .Item("Box_out").Format = "N0"
                .Item("Can_out").Format = "N0"
                .Item("NerkhStandard").Format = "N0"
                .Item("Can_out").Format = "N0"
                .Item("MojoodiRiali").Format = "N0"
                .Item("Can_out").Format = "N0"
                .Item("Can_out").Format = "N0"
                '.Item("kalano_kalads").MaxLength = 0
        ...
        If Not (gSM.ActionVisible("mnu__abSpr_MojoodiRiali") And gSM.ActionEnabled("mnu__abSpr_MojoodiRiali")) Then
            ...
            DVabKalaRahgiri.Fields.Item("NerkhStandard").MaxLength = 0
            DVabKalaRahgiri.Fields.Item("MojoodiRiali").MaxLength = 0

        End If
        DVabKalaRahgiri.Refresh()
    End Sub
    ...
    Private Sub btnSelect_Click(sender As System.Object, e As System.EventArgs) _
        ...
        If vErrMsg = "" Then
            ...
            FunCommon.DoFillDatasetSP(ds, "tblMojoodi", "_abSpr_Mojoodi", _Prr, cn, tp)


            'Dim dv As DataView = cn.SPQuery("_abSpr_Mojoodi", gVahedeTejariSN, strAnbars _
            ...
            'DVabKalaRahgiri.DataSource = dv.DataViewManager.DataSet

            'DVabKalaRahgiri = New CDataView(cn)

            DVabKalaRahgiri.DataSource = ds.Tables("tblMojoodi").DefaultView

            If vIsMahaleChideman = 1 Then
                'GridEX1.RootTable.Columns("ChidemanDS").Visible = True
                DVabKalaRahgiri.Fields.Item("ChidemanDS").MaxLength = 100
            Else
                'GridEX1.RootTable.Columns("ChidemanDS").Visible = False
                DVabKalaRahgiri.Fields.Item("ChidemanDS").MaxLength = 0
            End If
            ...
            If vRezerv = 1 Then
                ...
                DVabKalaRahgiri.Fields.Item("ShomarehRahgiri").MaxLength = 0
                DVabKalaRahgiri.Fields.Item("NoeTarakoneshkalaDS").MaxLength = 0
                DVabKalaRahgiri.Fields.Item("EnghezaDate").MaxLength = 0
            Else
                ...
                DVabKalaRahgiri.Fields.Item("ShomarehRahgiri").MaxLength = 100
                DVabKalaRahgiri.Fields.Item("NoeTarakoneshkalaDS").MaxLength = 100
                DVabKalaRahgiri.Fields.Item("EnghezaDate").MaxLength = 100
            End If
    ...
    Private Sub btnSelect2_Click(sender As System.Object, e As System.EventArgs) _
        ...
        If Len(txtSabtDate.Text) <> 0 Then
            _SabtDate = Len(txtSabtDate.Text)

        Else
            _SabtDate = ""
        End If
        If Len(txtMohlatDate.Text) <> 0 Then
            _MohlatdaTe = Len(txtMohlatDate.Text)
        ...
        With DVabMohlateForoosh
            ...
            .SQLWhere = "(" + _KalaSN2.ToString + " = 0 OR abMohlateForoosh.kalaSn = " & _KalaSN2 & "  ) And  " + _
                        ...
                        "(" + "'" & _MohlatdaTe & "'" + " = 0 OR abMohlateForoosh.MohlatdaTe = '" & _MohlatdaTe & "'  )  "
            '.SQLWhere = "1=1"
            .Refresh()
        End With
    End Sub
    ...
    Private Sub btnAdd_Click(sender As System.Object, e As System.EventArgs) Handles btnAdd.Click
        '@MohlateForooshSN decimal(18,3) OUTPUT,     
        Dim _KalaSN As Decimal = DVabKalaRahgiri.Fields("KalaSN").Value
        Dim _ShomarehRahgiri As String = DVabKalaRahgiri.Fields("ShomarehRahgiri").Value
        ...
        Dim _MohlatDate As String = ""
        Dim _Mojoodi As Double = DVabKalaRahgiri.Fields("Mojoodi").Value
        'Dim _MeghdareForoosh As Double
        'Dim _MohlateForooshStatusSN As Decimal
        'Dim _VahedeTejariSN As Decimal
        'Dim _AnbarSN As Decimal
        Dim _ToolidDate As String = DVabKalaRahgiri.Fields("ToolidDate").Value
        Dim _EnghezaDate As String = DVabKalaRahgiri.Fields("EnghezaDate").Value
        'Dim _UserID_Name As String
        'Dim _Host_Name As String
        'Dim _RecChksum As int

        cn.CallSP("abMohlateForoosh_Insert", gSM.Identifier, _KalaSN, _ShomarehRahgiri, _SabtDate, _MohlatDate, _Mojoodi, 0 _
                                         , 1.935, gVahedeTejariSN, gAnbarSN, _ToolidDate, _EnghezaDate, gSM.UserID_Name.ToString, System.Environment.MachineName, System.DBNull.Value)
