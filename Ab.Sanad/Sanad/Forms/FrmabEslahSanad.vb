    ...
    Private Sub InitializeComponent()
        ...
        Dim _
            resources As System.Resources.ResourceManager = _
                New System.Resources.ResourceManager(GetType(FrmEslahSanad))
        ...
        Me.txtEslahSanadNo.AutoSize = False
        ...
        Me.txtNewSanadDate.Text = ""
        Me.txtNewSanadDate.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        Me.txtNewSanadDate.Visible = False
        '
        'txtSanadDate
        '
        Me.txtSanadDate.AcceptsReturn = True
        Me.txtSanadDate.Anchor = _
            CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right),  _
                System.Windows.Forms.AnchorStyles)
        Me.txtSanadDate.AutoSize = False
        ...
        Me.lblSanadStatus.Size = New System.Drawing.Size(43, 17)
        ...
        Me.lblSanadNO.Size = New System.Drawing.Size(98, 17)
        ...
        Me.lblNewTarakoneshSN.Size = New System.Drawing.Size(45, 17)
        ...
        Me.lblNewSanadDate.Visible = False
        '
        'dbcNewTafsiliSN1
        '
        Me.dbcNewTafsiliSN1.Anchor = _
            CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmEslahSanad
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmEslahSanad
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmEslahSanad
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmEslahSanad)
...
#End Region
    ...
    Private Sub DVabEslahSanad_BindDBComponent(ByRef aComponent As Object) _
        ...
        With dbcSanadNo
            If aComponent Is DVabEslahSanad.Fields("SanadNo").Component Then
                ...
                vSql = " SELECT SanadSN , TarakoneshSN  " &
                       ...
                       " AND abSanad.TarakoneshSN Not IN ( 45 , 95, 1, 2 )  " &
    ...
    Private Sub FrmEslahSanad_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        Handles MyBase.Load
    ...
    Private Sub FrmEslahSanad_Closed(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
    ...
    Private Sub InitDataView()
        ...
        With DVabEslahSanad
            ...
            With .Fields
                ...
                End With
                With _
                    .Add("NewTafsiliSN->{ maTafsili.TafsiliNO + ' _ ' + maTafsili.TafsiliDS} AS NewTafsiliSN ", _
                          dbcNewTafsiliSN)
                ...
                End With
                With _
                    .Add("NewTafsiliSN1->{ maTafsili2.TafsiliNO + ' _ ' + maTafsili2.TafsiliDS} AS NewTafsiliSN1 ", _
                          dbcNewTafsiliSN1)
    ...
    Private Sub InitForm()
        ...
        'CSanad.SabtResidTaminkonandegan()
    End Sub
    ...
    Private Sub dbcNewTafsiliSN_Enter(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        If Val(DVabEslahSanad.Fields("SanadNo").Value) <> 0 Then
            ...
            Select Case vTarakoneshSN
                Case EnumTarakoneshSN.RESIDE_12_ENTEGHAL_AZ_ANBAR_BE_KARGAH _
                    ...
                    VComboWhereB = " AND ( maTafsili.TafsiliSN IN ( SELECT PayeSN FROM abAnbar " & _
                                   ...
                                   " AND (abAnbar.IsTajmie = 3) AND abAnbar.VahedeTejariSN  = " & CStr(gVahedeTejariSN) & _
                                   " )) "
                ...
                Case EnumTarakoneshSN.RESIDE_05_ENTEGHAL_AZ_ANBAR_BE_ANBAR _
                    ...
                    VComboWhereB = " AND ( maTafsili.TafsiliSN IN ( SELECT PayeSN FROM abAnbar " & _
                                   " Where ( ISNULL(abAnbar.AnbarStatus,0) = 1 ) " & _
                                   " AND (abAnbar.IsTajmie = 2) AND abAnbar.VahedeTejariSN  = " & CStr(gVahedeTejariSN) & _
                                   " )) "
                ...
                Case EnumTarakoneshSN.HAVALEH_81_ZAYEAT
                    VComboWhereB = _
                        " AND ( maTafsili.TafsiliSN IN ( SELECT PayeSN FROM abAnbar T1 INNER JOIN abAnbarTarakonesh T2 ON T1.AnbarSN = T2.AnbarSN " & _
            ...
            If Val(DVabEslahSanad.Fields("NewTafsiliSN").Value) = 0 Then
                vGetTaraKoneshGoroohTafsiliSN = _
    ...
    Private Sub btnStatus4_8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        Try
            ...
            cn.CallSP("_abSPC_Change_EslahSanadStatus", DVabEslahSanad.Fields("EslahSanadSN").Value _
    ...
    Private Sub dbcNewTafsiliSN1_Enter(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        If Val(DVabEslahSanad.Fields("SanadNo").Value) <> 0 Then
            ...
            DVabEslahSanad.Fields("NewTafsiliSN1").ComboWhereCondition = " maTafsili2.GoroohTafsiliSN IN " & _
                                                                          "(select GoroohTafsiliSN FROM dbo.abFnt_SelectLevel2GoroohTafsili( " & _
                                                                          CStr(vTarakoneshSN) & "," & _
                                                                          CStr(vNoeAnbarSN) & "," & _
