...
Public Class FrmTakhsisMahsolOnNewIrcAndGtin
    Inherits Minoo.Base.FTBaseForm
    Private components As System.ComponentModel.IContainer
    Private Shared m_vb6formdefinstance As FrmTakhsisMahsolOnNewIrcAndGtin
    ...
    Public Shared Property DefInstance() As FrmTakhsisMahsolOnNewIrcAndGtin

        Get

            If m_vb6formdefinstance Is Nothing OrElse m_vb6formdefinstance.IsDisposed Then
                m_initializingdefinstance = True
                m_vb6formdefinstance = New FrmTakhsisMahsolOnNewIrcAndGtin
        ...
        Set(ByVal Value As FrmTakhsisMahsolOnNewIrcAndGtin)
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTakhsisMahsolOnNewIrcAndGtin))
        ...
        Me.ChkGetLastData.Location = New System.Drawing.Point(766, 3)
        ...
        Me.BtnRefreshData.Location = New System.Drawing.Point(953, 3)
        ...
        '
        'FrmTakhsisMahsolOnNewIrcAndGtin
        '
        Me.BackColor = System.Drawing.SystemColors.GradientInactiveCaption
        Me.ClientSize = New System.Drawing.Size(1368, 634)
        Me.Controls.Add(Me.TabControl1)
        Me.Controls.Add(Me.Panel3)
        Me.Name = "FrmTakhsisMahsolOnNewIrcAndGtin"
    ...
    Private Sub FrmTakhsisMahsolOnNewIrcAndGtin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnRefreshData_Click(sender As Object, e As EventArgs) Handles BtnRefreshData.Click
        ...
        If IsSabtResidActive Then
            ...
            Try
                ...
                Try
                    DSCatalogue = abRule.GetBarcodeScannerData(gVahedeTejariSN, gAnbarSN, Fdate, Tdate, CInt(1), cn)  '1 replace With dcbanbarStatus.BoundText
                    ...
                    Else
                        ...
                        '    GridBarcodeDetail.DataSource = cn.ExecuteQuery("select  Distinct Top 100 Percent paKalaTamin.VahedeTejariSN TaminVahedeTejariSN,VahedeTejariNo TaminVahedeTejariNo,VahedeTejariDs TaminVahedeTejariDs,  " &
                        '"paKala.KalaSN  ,paKala.KalaNo, Case when isnull(KalaStatus,0)<>1 Then '<غیر فعال>' Else '' End + KalaDs KalaDS, Azmayesh GenericCodeMap,KalaStatus, " &
                        '"(Select Top 1 TedadAjza  from paVahedeSanjeshKala Where KalaSN=paKala.KalaSN And  VahedeSanjeshSN=9.935 And Pishfarz=1) TedadDarKarton, " &
                        '"(Select Top 1 TedadAjza  from paVahedeSanjeshKala Where KalaSN=paKala.KalaSN And  VahedeSanjeshSN=10.935 ) TedadDarBasteh " &
                        '"from  paKalaTamin Join paVahedeTejari Tamin On Tamin.VahedeTejariSN=paKalaTamin.VahedeTejariSN " &
                        '"Join paKala on pakala.KalaSN=paKalaTamin.KalaSN " &
                        '"Where len(isnull(paKala.IRC,''))>10 And len(isnull(paKala.GTIN,''))>10  And Tamin.NoeVahedeTejariSN in (14.935,16.935) Order by paKalaTamin.VahedeTejariSN Desc")
                        GridBarcodeDetail.DataSource = cn.ExecuteQuery("select * from abProductCatalogueKalairc")

                        GridBarcodeDetail.RetrieveStructure()
                        GridBarcodeDetail.Refetch()
        ...
        If IsAnbarGardaniActive Then
            ...
            Try
                DSCatalogue = Nothing
                DSCatalogue = abRule.GetBarcodeScannerData(gVahedeTejariSN, gAnbarSN, Fdate, Tdate, CInt(1), cn, "abSPG_ProductCatalogueGetDataForAnbarGardani") '1 replaced  with dcbanbarStatus.BoundText
    ...
    Private Sub FrmTakhsisMahsolOnNewIrcAndGtin_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
