...
Public Class FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport
...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        '
        'FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 14)
        Me.ClientSize = New System.Drawing.Size(1046, 534)
        Me.Name = "FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "گزارش مغایرت کاتالوگ محصولات با سیستم مپ  "
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport)
...
#End Region
    ...
    Private Sub FrmMoghayerateKatalogeMahsoolatBaSystemMaprReport_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        Handles MyBase.Load
    ...
    Private Sub btnViewReport_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        ...
        Try
            ...
            Cmnd.CommandText = "abSPR_MoghayeratProductCatalogueWithMap"
