...
Public Class FrmReportDarkhastRepair

    ''
    Inherits JanusSimpleReport.frmRptJanusBase

    Private Shared m_vb6FormDefInstance As FrmReportDarkhastRepair
    Private Shared m_InitializingDefInstance As Boolean
        Private dclFDate As NetSql.Components.CDateCtrl
        Private dclTDate As NetSql.Components.CDateCtrl


    Public Shared Property DefInstance() As FrmReportDarkhastRepair
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmReportDarkhastRepair
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmReportDarkhastRepair)
            m_vb6FormDefInstance = Value
        End Set
    End Property

    Private Sub FrmReportDarkhastRepair_load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub btnViewReport_Click(sender As Object, e As EventArgs) Handles btnViewReport.Click
            ...
            If vErrMsg = "" Then
                ...
                Try
                    ...
                    DvReport = AnbarRule.RptDarkhastRepair_GetReport(vFromDate, vToDate, VAmvalSN, VahedetejariSN, VStatusSN, cn)
