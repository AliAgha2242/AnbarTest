...
Public Class FrmVaznRialiHavaleha

#Region "Upgrade Support "

    Private Shared m_vb6FormDefInstance As FrmVaznRialiHavaleha
    Private Shared m_InitializingDefInstance As Boolean
    Private dclFDate As NetSql.Components.CDateCtrl
    Private dclTDate As NetSql.Components.CDateCtrl


    Public Shared Property DefInstance() As FrmVaznRialiHavaleha
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmVaznRialiHavaleha
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmVaznRialiHavaleha)
...
#End Region
    ...
    Private Sub InitControls()
        ...
        " where absanad.vahedetejarisn= " & gVahedeTejariSN & " and tarakoneshsn>50 order by matafsili.tafsilisn", "tafsilisn", "tafsilids")
    ...
    Private Sub btnViewReport_Click(sender As System.Object, e As System.EventArgs) Handles btnViewReport.Click
        ...
        Dim _SanadSn As String = IIf(dbcSanadNo.getStringValues() <> "" And dbcSanadNo.MatchedWithList, dbcSanadNo.getStringValues(), "")
        Dim _TarakoneshSn As String = IIf(dbcTarakonesh.getStringValues() <> "" And dbcTarakonesh.MatchedWithList, dbcTarakonesh.getStringValues(), "")
        Dim _TafsiliSn As String = IIf(dbcTafsili.getStringValues() <> "" And dbcTafsili.MatchedWithList, dbcTafsili.getStringValues(), "")


        GridEX1.DataSource = cn.ExecuteQuery("_abSPR_VAzneRialiHavalehha '" & _SanadSn & "','" & _TarakoneshSn & "','" & _TafsiliSn & "','" & vFromDate & "','" & vToDate & "'")
