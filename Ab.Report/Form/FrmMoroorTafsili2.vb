...
'System ::انبار
Public Class FrmMoroorTafsili2
...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMoroorTafsili2))
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmMoroorTafsili2
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmMoroorTafsili2
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmMoroorTafsili2
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmMoroorTafsili2)
    ...
    Private Sub setColumnProperties()
        ...
        With GridEX1.RootTable.Columns()
            ...
            With .Add("KalaDS", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "شرح کالا"
            End With
            With .Add("MojoodiAval", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "موجودی اول دوره"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
            ...
            With .Add("MeghdareSadereh", Janus.Windows.GridEX.ColumnType.Text)
                ...
                .TotalFormatString = "#,#.###"
            End With
            With .Add("MandehTedad", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "مانده"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
            With .Add("Mojoodiaval_RV", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "مبلغ اول دوره واقعی"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
            With .Add("MeghdareVaredeh_RV", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "مبلغ وارده واقعی"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
            With .Add("MeghdareSadereh_RV", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "مبلغ صادره واقعی"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
            With .Add("MandehTedad_RV", Janus.Windows.GridEX.ColumnType.Text)
                .Caption = "مبلغ مانده واقعی"
                .FormatString = "#,#.###"
                .TotalFormatString = "#,#.###"
            End With
        End With
