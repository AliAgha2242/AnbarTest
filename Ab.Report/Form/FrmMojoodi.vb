...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMojoodi))
        ...
        Me.dcbKala.LateBindingTop = "200"
        Me.dcbKala.Location = New System.Drawing.Point(668, 12)
        ...
        Me.Label5.Location = New System.Drawing.Point(998, 13)
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmMojoodi
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmMojoodi
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmMojoodi
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FrmMojoodi)
...
#End Region
    Dim ShowGheymatKharid As Boolean = False
    ...
    Private Sub btnViewReport_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        ...
        Dim vRezerv, vIsMahaleChideman, vIRC As Short
        ...
        Dim StrTaminKonandehSN As String
        ...
        If vErrMsg = "" Then
            ...
            '    If Trim(VFilterAsnadAnbar.VisibleTaminKonandeh) <> "" Then
            '        vStrFilterSelectedTaminKonandehSN = Trim(VFilterAsnadAnbar.SelectedTaminKonandehSN)
            '    End If
            'Else

            If String.IsNullOrEmpty(Trim(VFilterAsnadAnbar.VisibleTaminKonandeh)) = False Then

                StrTaminKonandehSN = Trim(VFilterAsnadAnbar.SelectedTaminKonandehSN)
            End If
            'End If

            If _
                    Trim(VFilterAsnadAnbar.SelectedFromSabtDate) <> "" AndAlso
            ...
            If _
                    Trim(VFilterAsnadAnbar.SelectedFromShomarehSefaresh) <> "" AndAlso
            ...
            If _
                Trim(VFilterAsnadAnbar.SelectedFromShomarehRahgiri) <> "" AndAlso
            ...
            Dim gNamayeshIRC As Boolean = If(CApp2.GetAppConfig("gNamayeshIRC") Is System.DBNull.Value, False, True)

            GridEX1.RootTable.Columns("IRC").Visible = False
            GridEX1.RootTable.Columns("GTIN").Visible = False


            If (gNamayeshIRC = True) Then
                If Not GridEX1.RootTable.Columns("IRC") Is Nothing Then
                    GridEX1.RootTable.Columns("IRC").Visible = True
                End If
                If Not GridEX1.RootTable.Columns("GTIN") Is Nothing Then
                    GridEX1.RootTable.Columns("GTIN").Visible = True
                End If
            End If
            '' ghasemi 14010627
            ...
            Cmnd.CommandText = "_abSpr_Mojoodi "
            ...
            Cmnd.Parameters.AddWithValue("@FromDate", (vFromDate))
            Cmnd.Parameters.AddWithValue("@ToDate", vToDate)
            Cmnd.Parameters.AddWithValue("@StrKalaSN", CStr(vStrKalaSN))
            Cmnd.Parameters.AddWithValue("@SanadStatus", vSanadStatus)
            Cmnd.Parameters.AddWithValue("@NoeTarakoneshKalaNO", CStr(vNoeTarakoneshKalaNO))
            Cmnd.Parameters.AddWithValue("@Rezerv", vRezerv)
            Cmnd.Parameters.AddWithValue("@StrTarakoneshSN", DBNull.Value)
            Cmnd.Parameters.AddWithValue("@StrFilterSelectedGoroohSN", (vStrFilterSelectedGoroohSN))
            Cmnd.Parameters.AddWithValue("@StrFilterSelectedChidemanSN", vStrFilterSelectedChidemanSN)
            Cmnd.Parameters.AddWithValue("@IsMahaleChideman", vIsMahaleChideman)
            Cmnd.Parameters.AddWithValue("@FromSabtDate", vFromSabtDate)
            Cmnd.Parameters.AddWithValue("@ToSabtDate", vToSabtDate)
            Cmnd.Parameters.AddWithValue("@FromShomarehSefaresh", (vFromShomarehSefaresh))
            Cmnd.Parameters.AddWithValue("@ToShomarehSefaresh", vToShomarehSefaresh)
            Cmnd.Parameters.AddWithValue("@FromShomarehRahgiri", vFromShomarehRahgiri)
            Cmnd.Parameters.AddWithValue("@ToShomarehRahgiri", vToShomarehRahgiri)
            Cmnd.Parameters.AddWithValue("@Tozih", vTozih)
            Cmnd.Parameters.AddWithValue("@StrTafsiliSN", vTafsiiSN)
            Cmnd.Parameters.AddWithValue("@StrNoeZayeatSN", vNoeZayeatSN)
            Cmnd.Parameters.AddWithValue("@StrNoeMarjooeiSN", vNoeMarjooeiSN)
            Cmnd.Parameters.AddWithValue("@StrTaminKonandehSN", CStr(StrTaminKonandehSN))
            ...
            'GridEX1.DataSource = cn.SPQuery("_abSpr_Mojoodi", gVahedeTejariSN, strAnbars _
            '                                     , CStr(vFromDate), vToDate, vStrKalaSN, vSanadStatus _
            '                                     , vNoeTarakoneshKalaNO, vRezerv, strTarakoneshs, vStrFilterSelectedGoroohSN _
            '                                     , vStrFilterSelectedChidemanSN, vIsMahaleChideman, vFromSabtDate,
            '                                     vToSabtDate, vFromShomarehSefaresh, vToShomarehSefaresh _
            '                                     , vFromShomarehRahgiri, vToShomarehRahgiri, vTozih, vTafsiiSN, vNoeZayeatSN,
            '                                     vNoeMarjooeiSN, StrTaminKonandehSN)
            ...
            GridEX1.RootTable.Columns("GheymatKharid").Visible = ShowGheymatKharid
    ...
    Private Sub SetColumnProperties()
        ...
        Dim CApp2 As Configuration.CAppSetting = New Configuration.CAppSetting(gVahedeTejariSN, gSM.ApplicationID)
        Dim gNamayeshIRC As Boolean = If(CApp2.GetAppConfig("gNamayeshIRC") Is System.DBNull.Value, False, True)
        ShowGheymatKharid = If(CApp2.GetAppConfig("gMohasebehGheymatKharidDarMojoodiAnbar") Is System.DBNull.Value, False, True)


        GridEX1.RootTable.Columns("IRC").Visible = False
        GridEX1.RootTable.Columns("GTIN").Visible = False
        GridEX1.RootTable.Columns("GheymatKharid").Visible = False



        If (ShowGheymatKharid = True) Then
            If Not GridEX1.RootTable.Columns("GheymatKharid") Is Nothing Then
                GridEX1.RootTable.Columns("GheymatKharid").Visible = True
                GridEX1.RootTable.Columns("GheymatKharid").FormatString = "N0"
