...
Public Class FrmShowSpecifications
...
#Region "Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "FrmShowSpecifications"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "مشاهده مشخصات سند"
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmShowSpecifications
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmShowSpecifications
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmShowSpecifications
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set (ByVal Value As FrmShowSpecifications)
...
#End Region
    ...
    Private Sub FrmShowSpecifications_Load (ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        Handles MyBase.Load
        ...
        With DViewer
            ...
            .QueryName = "abQuery_ShowSpecifications"
            ' جهت تهيه گزارش با توجه به پارامترهاي مورد نياز 
            ' سلکت  گزارش اجرا ميگردد و خروجي در اختيار گريد قرار ميگيرد
            .SQLSelect = _
                "Select abSanad.SanadNo AS 'شماره سند',abTarakonesh.TarakoneshDS AS 'تراکنش',abSanad.MoaserDate AS 'تاريخ سند',abSanad.SabtDate AS 'تاريخ ثبت',abSanad.TaeedDate AS 'تاريخ قطعي',abVw_NoeSanad.NoeSanadDS AS 'نوع سند',abSanad.Tozih AS 'توضيحات'  " & _
                " from abSanad " & _
                " JOIN abTarakonesh ON abSanad.TarakoneshSn = abTarakonesh.TarakoneshSn " & _
                " LEFT JOIN  abVw_NoeSanad ON abSanad.NoeSanadID = abVw_NoeSanad.NoeSanadID " & _
                " Where abSanad.SanadSn IN ( " & vSanadSn & " ) " & _
    ...
    Private Sub FrmShowSpecifications_Closed (ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Me.Dispose()
    End Sub
End Class
