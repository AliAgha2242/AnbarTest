...
#Region "Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnSelect.Location = New System.Drawing.Point (282, 249)
        ...
        Me.btnExit.Location = New System.Drawing.Point (167, 251)
        ...
        Me.Name = "FrmShowChideman"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "مشاهده محل چيدمان کالا"
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As FrmShowChideman
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As FrmShowChideman
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FrmShowChideman
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set (ByVal Value As FrmShowChideman)
...
#End Region
    ...
    Private Sub FrmShowChideman_Load (ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        Handles MyBase.Load
        ...
        If vKalaSn Is Nothing Then Exit Sub
        ...
        With DViewer
            ...
            .QueryName = "abQuery_ShowChideman"
            ' جهت تهيه گزارش با توجه به پارامترهاي مورد نياز 
            ' سلکت  گزارش اجرا ميگردد و خروجي در اختيار گريد قرار ميگيرد
            .SQLSelect = "Select KalaDs AS 'کالا',dbo.abFn_GetTreeabChidemanNo(ChidemanSn) AS 'محل چيدمان'  " & _
                         " from abKalaChideman " & _
                         " join abKalaPhiziki on abKalaChideman.KalaPhizikiSn = abKalaPhiziki.KalaPhizikiSn " & _
                         " join paKala on paKala.KalaSn = abKalaPhiziki.KalaSn  " & _
                         " Where abKalaPhiziki.KalaSn in ( " & vKalaSn & " ) "
            vfgGrid = .FlexGrid
            .Refresh()
        End With
    ...
    Private Sub FrmShowChideman_Closed (ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Me.Dispose()
    End Sub
End Class
