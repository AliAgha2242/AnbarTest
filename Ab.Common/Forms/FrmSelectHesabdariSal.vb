...
Public Class frmSelectHesabdariSal
...
#Region "Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnSelect.Location = New System.Drawing.Point (241, 251)
        ...
        Me.btnExit.Location = New System.Drawing.Point (89, 251)
        ...
        Me.picGrid.Size = New System.Drawing.Size (416, 248)
        Me.picGrid.TabIndex = 0
        '
        'frmSelectHesabdariSal
        '
...
#Region "Upgrade Support "
    ...
    Private Shared m_vb6FormDefInstance As frmSelectHesabdariSal
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As frmSelectHesabdariSal
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New frmSelectHesabdariSal
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set (ByVal Value As frmSelectHesabdariSal)
...
#End Region
    ...
    'يك ديتا ويو از نوع ابزار جهت نمايش  سالهاي مالي تعريف شده است
    ...
    Private Sub btnSelect_Click (ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        ...
        ' انتخاب سال مالي 
        ' مقدار دهي متغييرهاي سراسري سال مالي
        With DViewer.FlexGrid
            If (.Rows - .FixedRows) > 0 Then
                ...
                If gAnbarSN > 0 And gHesabdariSal > 0 Then
                    tp.Settings("AnbarSettings\HesabdariSal\AnbarSN_" & CStr(gAnbarSN) &
                                 "\LocationID_" & CStr(gSM.SystemLocationSN), "LastHesabdariSal") =
                        CStr(gHesabdariSal)
                End If
            End If
        End With
    ...
    Private Sub frmSelectHesabdariSal_Load (ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) _
        Handles MyBase.Load
        ...
        With DViewer
            .Init (picGrid)
            .TableName = "maHesabdariSal"
            .SQLWhere = " maHesabdariSal.HesabdariSN IN " & _
                        " (Select HesabdariSN From maHesabdari Where maHesabdari.VahedeTejariSN =  " _
                        + CStr (gVahedeTejariSN) + " ) "
            .SQLOrderBy = "maHesabdariSal.FDate Desc"
            .Text = FTDD.GetCaption (.TableName)
            .EditInGrid = False
            .AccessRight = EnumAccessRight.arView
            .AutoFetchCurrentRow = False
            With .Fields
                With .Add ("HesabdariSalSN", , EnumFieldOptions.foHidden)
                    .DefaultValue = gSM.Identifier
                End With
                .Add ("HesabdariSN", , EnumFieldOptions.foHidden)
                With .Add ("HesabdariSal", "TextBox")
                    .MaxLength = 4
                    .DataType = "int"
                End With
                .Add ("FDate", "TextBox", EnumFieldOptions.foDate)
                .Add ("TDate", "TextBox", EnumFieldOptions.foDate)
                .Add ("ISClosed", "CheckBox<Disabled>")
                With .Add ("Tozih", "TextBox", EnumFieldOptions.foHidden)
                End With
                With .Add ("UserID_Name", , EnumFieldOptions.foHidden)
                    .DefaultValue = gSM.UserID_Name
                End With
                With .Add ("Host_Name", , EnumFieldOptions.foHidden)
                    .DefaultValue = SystemInformation.ComputerName
                End With
            End With
            vfgGrid = .FlexGrid
            .Refresh()
        ...
        vLastHesabdariSal = Val (tp.Settings ("AnbarSettings\HesabdariSal\AnbarSN_" & CStr (gAnbarSN) & _
                                              "\LocationID_" & CStr (gSM.SystemLocationSN), "LastHesabdariSal", 0))
        If vLastHesabdariSal > 0 Then
            vLastRow = _
                DViewer.FlexGrid.FindRow (vLastHesabdariSal, DViewer.FlexGrid.FixedRows - 1, _
                                          DViewer.FlexGrid.ColIndex ("HesabdariSal"), True, True)
            DViewer.FlexGrid.Row = IIf (vLastRow < 1, 1, vLastRow)
        End If
    End Sub
